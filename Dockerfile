...
RUN apt-get update && apt-get install -y libxt6  git-core imagemagick libcurl4-openssl-dev libgit2-dev libicu-dev libpng-dev libssl-dev libfontconfig1-dev libcairo2-dev libxml2-dev make pandoc pandoc-citeproc && rm -rf /var/lib/apt/lists/*
