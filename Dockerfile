...
RUN apt-get update && apt-get install -y  git-core imagemagick libcairo2-dev libcurl4-openssl-dev libgit2-dev libicu-dev libpng-dev libssl-dev libxml2-dev xdg-utils make pandoc pandoc-citeproc zlib1g-dev && rm -rf /var/lib/apt/lists/*
